      ...
      <>
        <div className="content-container">
          ...
          <div className="following-info-box">
            ...
            is on September 8, before orientation week and before students will be
          ...
          <div className="following-info-box">
            ...
            <a href="https://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=8589993551">
            https://sos.nh.gov/WorkArea/DownloadAsset.aspx?id=8589993551</a>
            for instructions on how to fill out and submit your absentee ballot </p>
          </div>
          <div className="following-info-box">
            <p className="box-title">About Riley</p>
            <p className="box-information">Riley is a Dartmouth ‘22 running to
            ...
            <br />
            Since Garrett is leaving the state house, Riley is running to make sure one of those four is someone who will represent Dartmouth students as a young voice on issues important to students, especially important given the state house’s average age of 61. If elected, Riley aims to increase energy efficiency standards and renewable energy production, protect every student’s right to vote, and enact common sense gun laws. For more information, visit rileyfornh.com or email info@rileyfornh.com. </p>
          </div>
          <br />
          <br />
        </div>
